        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0 pe-4">
                    ...
                    <a hre@extends('layouts/layout_welcome');
                    ...
                    @endsectionf="#contact" class="nav-item nav-link">Contact</a>
                </div>
                <div class="nav-item dropdown ms-3">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="fa fa-user"></i> User
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <small class="fst-italic">Tumpukan pancake lembut dengan pilihan topping seperti madu, maple syrup, atau buah-buahan.</small>
                                        <button class="material-symbols-outlined btn-custom" style="background-color:orange; color:white; border-color:orange;">
                                            pesan
                                        </button>
                                    </div>
                                </div>
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control" id="email" placeholder="Your Email">
                                    <label for="email">No WhatssApp</label>
                                </div>
                            </div>
                            <div class="col-md-6">
